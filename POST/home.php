...
<body>
	<div id="container">
		...
		<br>
					...
					<br>
					<button name="post" type="submit" class="btn btn-primary btn-block btn-lg">POST</button>
					...
					<button name="comment" type="submit" class="btn btn-primary btn-block btn-lg">Comment</button>
					</form>
